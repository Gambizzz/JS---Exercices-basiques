...
let codonToProtein = function(letters) {
    switch (letters) {
        case 'UCU':
        case 'UCC':
        case 'UCA':
...
console.log(`Protéines de ${arn1} : ${proteinList(arn1)}`);
console.log(`Protéines de ${arn2} : ${proteinList(arn2)}`);